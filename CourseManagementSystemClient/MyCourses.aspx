<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyCourses.aspx.cs" Inherits="CourseManagementSystemClient.MyCourses" %>
    ...
    <nav class="fixed top-0 left-0 w-full bg-gradient-to-r from-blue-500 to-blue-700 shadow-lg h-16 w-full fixed top-0">
        <div class="flex justify-between items-center h-full px-4">
            ...
            <ul class="flex space-x-4">
                <li>
                    <a href="StudentHomePage.aspx" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition duration-300"> Dashboard </a>
                </li>
                <li>
