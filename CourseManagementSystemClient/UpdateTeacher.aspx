<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateTeacher.aspx.cs" Inherits="CourseManagementSystemClient.UpdateTeacher" %>
...
<body>
    ...
    <div class="pt-20 flex justify-center items-center">
        <div class="bg-white shadow-md rounded-lg px-8 py-10 max-w-md w-full">
            <h2 class="text-center text-3xl font-bold text-gray-800 mb-8"> Update Teacher </h2>
                ...
                <div class="mb-4">
                    <label for="txtPhoneNo" class="block text-gray-700 text-sm font-bold mb-2">Mobile Number:</label>
                    <asp:TextBox ID="txtPhoneNo" runat="server" CssClass="form-input w-full px-4 py-2 rounded-lg focus:outline-none focus:ring focus:border-blue-500 border border-gray-300" pattern="[0-9]{10}" title="Phone number must be 10 digits." inputmode="numeric" Placeholder="Enter your mobile number" required />
                </div>
                <div class="flex justify-center">
                    <asp:Button ID="btnUpdate" runat="server" Text="Update Teacher" CssClass="cursor-pointer bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-700 hover:to-blue-900 text-white px-6 py-3 rounded-lg shadow-lg focus:outline-none focus:ring focus:border-blue-500 transition-all duration-300 ease-in-out" onClick="btnUpdate_click"/>
                </div>
        </div>
    </div>
    </form>
