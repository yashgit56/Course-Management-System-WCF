<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageTeachers.aspx.cs" Inherits="CourseManagementSystemClient.ManageTeachers" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="shadow-md rounded-lg overflow-hidden mt-12 mx-4">
            <asp:GridView ID="grdTeachers" runat="server" AutoGenerateColumns="False" DataKeyNames="TeacherId"
                OnRowEditing="grdTeachers_RowEditing" OnRowDeleting="grdTeachers_RowDeleting"
                CssClass="border-collapse w-full text-center">
                <Columns>
                    <asp:BoundField DataField="TeacherId" HeaderText="Teacher ID" ReadOnly="true" ItemStyle-CssClass="py-3 px-6 text-left" />
                    ...
                    <asp:BoundField DataField="PhoneNo" HeaderText="Phone Number" ItemStyle-CssClass="py-3 px-6" />
                    <asp:TemplateField ItemStyle-CssClass="py-3 px-6">
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="lnkDelete" runat="server" CommandName="Delete" Text="Delete" CssClass="inline-block bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" OnClientClick="return confirm('Are you sure you want to delete this teacher?')" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
