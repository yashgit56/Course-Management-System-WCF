<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminPage.aspx.cs" Inherits="CourseManagementSystemClient.AdminHomePage" %>
...
<body>
    ...
    <footer class="bg-gradient-to-r from-blue-500 to-blue-700 py-4 mt-4 fixed bottom-0 w-full">
